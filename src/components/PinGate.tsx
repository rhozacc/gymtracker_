          ...
          <div className="flex gap-3 justify-center mb-6">
            {pin.map((digit, i) => (
              <input
                ...
                disabled={loading}
                className="w-14 h-14 bg-surface border border-border text-accent text-center text-2xl font-mono rounded focus:border-accent focus:outline-none disabled:opacity-50"
                autoFocus={i === 0}
              />
            ))}
          </div>

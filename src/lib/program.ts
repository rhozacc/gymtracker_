...
export const PLANS: Record<string, PlanDefinition> = {
  ...
  upper_lower: {
    id: "upper_lower",
    name: "Upper / Lower",
    description: "4-day split: strength and hypertrophy days for upper and lower body",
    fit: "The classic 4-day split. Strength days build your base, hypertrophy days add size. Best of both worlds.",
    category: "men",
    goal: "bulk",
    days: {
      upper_strength: {
        ...
        exercises: [
          { id: "bench_press", name: "Bench press", sets: 4, repRange: [4, 6], increment: 2.5, rest: 180 },
          { id: "barbell_row", name: "Barbell row", sets: 4, repRange: [4, 6], increment: 2.5, rest: 150 },
          { id: "ohp", name: "Overhead press", sets: 3, repRange: [5, 7], increment: 2.5, rest: 150 },
          { id: "weighted_pullup", name: "Weighted pull-up", sets: 3, repRange: [5, 7], increment: 2.5, rest: 120 },
          { id: "weighted_dips", name: "Weighted dips", sets: 3, repRange: [6, 8], increment: 2.5, rest: 90 },
      ...
      lower_strength: {
        ...
        exercises: [
          { id: "squat", name: "Low bar squat", sets: 4, repRange: [4, 6], increment: 2.5, rest: 180 },
          { id: "rdl", name: "Romanian deadlift", sets: 4, repRange: [5, 7], increment: 5, rest: 150 },
          { id: "leg_press", name: "Leg press", sets: 3, repRange: [6, 8], increment: 10, rest: 120 },
          { id: "lying_curl", name: "Lying leg curl", sets: 3, repRange: [8, 10], increment: 2.5, rest: 75 },
      ...
      upper_hypertrophy: {
        ...
        exercises: [
          { id: "incline_db_press", name: "Incline DB press", sets: 4, repRange: [8, 12], increment: 2.5, rest: 75 },
          { id: "pulldown", name: "Lat pulldown", sets: 4, repRange: [10, 12], increment: 2.5, rest: 60 },
          { id: "seated_db_press", name: "Seated DB press", sets: 3, repRange: [10, 12], increment: 2.5, rest: 75 },
      ...
      lower_hypertrophy: {
        ...
        exercises: [
          { id: "bulgarian_split_squat", name: "Bulgarian split squat", sets: 4, repRange: [10, 12], increment: 2.5, rest: 75 },
          { id: "hip_thrust", name: "Barbell hip thrust", sets: 4, repRange: [10, 12], increment: 5, rest: 75 },
          { id: "leg_extension", name: "Leg extension", sets: 3, repRange: [12, 15], increment: 5, rest: 60 },
          { id: "lying_curl_hyp", name: "Lying leg curl", sets: 3, repRange: [12, 15], increment: 2.5, rest: 60 },
          { id: "walking_lunge", name: "Walking lunge", sets: 3, repRange: [12, 14], increment: 2.5, rest: 60 },
          { id: "calf_raise_hyp", name: "Seated calf raise", sets: 4, repRange: [12, 15], increment: 2.5, rest: 45 },
        ],
      },
    },
  },
